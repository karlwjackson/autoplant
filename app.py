...
st.caption("Source: Azure Blob (Microsoft Entra ID auth) → Container merges all files")
...
def get_container_client() -> BlobServiceClient:
    """
    Uses DefaultAzureCredential:
      - Locally: 'az login' and your Entra user
      - In Azure: Managed Identity automatically
    """
...
def _clean_df(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Handles sources that write "null", "None", "N/A", "" as *strings*
